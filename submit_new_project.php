...
if($_GET['post'] != false)
{
	...
	$tpl->assign('msg', $l->t('Project \'%s\' has been created successfully.', array($_GET['title'])));
}
else
{
	$tpl->assign('title', $l->t('Failed'));
	$tpl->assign('msg', $l->t('Project \'%s\' cannot be created. Kindly try after some time.', array($_GET['title'])));
}
