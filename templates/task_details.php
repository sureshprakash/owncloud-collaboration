...
?>
<div id="app-content">
  <h1 id="title"><?php p($l->t('Task details')); ?></h1>
  <div id="tasks-wrapper">
	<table id="details">
		<tr>
			<td><?php p($l->t('Project')); ?></td>
			<td><?php p($_['task_details']['proj_title']); ?></td>
		</tr>
    <tr>
			<td><?php p($l->t('Task Title')); ?></td>
      <td><?php p($_['task_details']['title']); ?></td>
		</tr>
    <tr>
	...
	?>
	 ...
	 <?php if(strcasecmp(OC_Collaboration_Task::getTaskCreator($_['task_details']['tid']), OC_User::getUser()) == 0) { ?>
