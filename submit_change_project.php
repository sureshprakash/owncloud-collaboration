...
if($_GET['post'] != false)
{
	...
	$tpl->assign('msg', $l->t('Project \'%s\' has been updated successfully.', array($_GET['title'])));
}
else
{
	$tpl->assign('title', $l->t('Failed'));
	$tpl->assign('msg', $l->t('Project \'%s\' cannot be updated. Kindly try after some time.', array($_GET['title'])));
}
